  ...
  return (
    <>
      ...
      <div className="quick-starts">
        {QUICK_STARTS.map(qs => (
          <button key={qs.label} className="quick-start" onClick={() => startQuick(qs)} disabled={busy}>
            <span className="quick-start-emoji">{qs.emoji}</span>
            <span className="quick-start-label">{qs.label}</span>
          </button>
        ))}
      </div>
